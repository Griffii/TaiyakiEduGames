...
<template>
    <div>
        ...
        <aside
            ...
            aria-label="Announcements and textbooks"
        >
            <header class="side-panel__header">
                ...
                <h2 class="side-panel__title">Study Hub</h2>
            </header>

            <div class="side-panel__scroll">
                <!-- User Level Tracker (more compact + full width) -->
                <section class="levels-centered">
                    <UserLevels />
                </section>

                <!-- Custom Deck Button -->
                <section class="side-panel-centered">
                    <CustomDeckButton />
                </section>
        ...
        <button
            v-if="!isOpen"
            type="button"
            class="side-toggle side-toggle--right"
            @click="openPanel"
...
<style scoped>
/* Fixed right panel overlay, under the fixed header */
.side-panel {
    position: fixed;
    ...
    border-left: var(--header-border-width, 3px) solid var(--header-border-color);
...
.side-panel--open.side-panel--right {
...
/* Level data section — full width + compact vertical spacing */
.levels-centered {
    width: 100%;
    display: flex;
    ...
    /* Shrink the vertical space taken by this section */
    margin: 0.25rem 0;
    padding: 0.25rem 0;
}


/* Centered Item (CustomDeckButton, TextbookPillList) */
.side-panel-centered {
    width: 100%;
    display: flex;
    align-items: center;
...
/* Circle toggle button when collapsed */
.side-toggle {
    position: fixed;
